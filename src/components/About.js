...
const About = () => {
  return (
    <>
      <div className="px-5 pb-4 lg:px-36 lg:py-10 text-white">
        <div className="bg-secondary-dark rounded-xl py-2 sm:py-4 bg-opacity-45">
          ...
          <div className="block md:flex">
            <div className="px-0 w-56 h-auto md:w-[700px] md:px-6 mx-auto">
              <img
                className="bg-cover shadow-md shadow-slate-400/30 rounded-full"
                src={img}
                alt=""
              />
              <p className="text-center mt-2 text-2xl sm:text-base lg:text-2xl">
                Rushikesh Wani
              </p>
            ...
            <div className="text-sm md:text-base text-justify text-white p-2 sm:p-4 rounded-xl">
              <p>
                Welcome to my portfolio! As a highly motivated and ambitious
                multidisciplinary engineering student, I am eager to expand my
                knowledge and leverage my skills in the field of web
                development. My strong desire and passion for gaining a better
                understanding of React.js drive my confidence in excelling in my
                work.
              </p>
              <p>
                A key strength of mine lies in swiftly adapting to newer
                technologies, ensuring I stay at the forefront of the rapidly
                evolving field of full stack web development. Every day, I
                eagerly pursue opportunities to learn, whether through projects
                or by exploring new concepts. Firmly believing in the power of
              ...
              <p>
                ...
                contribute to a team and help drive organizational success. With
                a strong proficiency in React.js, I have developed projects such
                as Food Villa and a YouTube clone, showcasing my skills and
              ...
              <p>
                ...
                fellow professionals, so please don't hesitate to reach out.
