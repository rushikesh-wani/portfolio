...
const Skills = () => {
  return (
    <div className="bg-zinc-950 px-5 lg:px-36 lg:py-10 lg:pt-4 text-white">
      <h1 className="text-3xl text-gray-300 font-medium py-2 sm:py-4 text-center">
        Skills
      </h1>
      <div className="cards-container flex flex-wrap gap-x-2 gap-y-2 justify-center">
        <div className="w-28 h-32 bg-slate-900 p-4 rounded-xl shadow-md  shadow-neutral-500/20 hover:shadow-neutral-500/50">
          <svg
          ...
          <p className="text-sm text-center">C Programming</p>
        </div>
        <div className="w-28 h-32 bg-slate-900 p-4 rounded-xl shadow-md  shadow-neutral-500/20 hover:shadow-neutral-500/50">
          <svg
        ...
        <div className="w-28 h-32 bg-slate-900 p-4 rounded-xl shadow-md  shadow-neutral-500/20 hover:shadow-neutral-500/50">
          ...
          <p className="text-sm text-center">R programming</p>
        </div>
        <div className="w-28 h-32 bg-slate-900 p-4 rounded-xl shadow-md  shadow-neutral-500/20 hover:shadow-neutral-500/50">
          <svg
            className="drop-shadow-2xl mx-auto"
