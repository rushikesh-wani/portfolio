...
const Project = () => {
  return (
    <div className="bg-zinc-950 px-5 pb-5 lg:px-36 lg:py-10 lg:pt-4 text-white">
      ...
      <div className="cards-container mx-auto flex flex-wrap md:flex-nowrap gap-x-2 gap-y-2 sm:gap-x-5 sm:gap-y-5 justify-center align-middle items-center">
        <div className="Card w-auto h-auto sm:w-80 rounded-xl hover:shadow-md hover:shadow-neutral-500/50">
          ...
          <div className="py-3 px-3 bg-slate-900 rounded-bl-lg rounded-br-lg">
            ...
            <p className="text-xl font-medium">MERN CRUD Application</p>
